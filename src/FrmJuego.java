...
public class FrmJuego extends JFrame {
    ...
    public FrmJuego() {
        ...
        lblDado1.setBounds(10,40,imagen.getIconWidth(),imagen.getIconHeight());
        getContentPane().add(lblDado1);

        JLabel lblDado2= new JLabel();
        lblDado2.setIcon(imagen);
        lblDado2.setBounds(10+imagen.getIconWidth(),40,imagen.getIconWidth(),imagen.getIconHeight());
        ...
        btnIniciar.setBounds(10, 95+imagen.getIconHeight(), 100, 25);
